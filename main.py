...
#Bottom Left Frame
lable_start = Label(fb1,text="Start Here",font=("Helventica",18,"bold"),foreground="red")
lable_start.place(x=10,y=10)
...
loc_entry = Entry(fb1,textvariable=location,relief="solid",font=("Helventica",11))
loc_entry.place(x=100,y=85,width=350,height=20)
open_button = Button(fb1,text="Open",relief="groove")
open_button.place(x=470,y=75)
